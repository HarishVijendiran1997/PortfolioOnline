...
const Proj9 = () => {
    ...
    const github = "https://github.com/HarishVijendiran1997/live-face-emotion-detector"
    const live = "https://live-face-emotion-detector.vercel.app/"
    ...
    return (
        <div role='img' aria-label="Live face emotion detections" onClick={handleClick} className='transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center h-[200px] bg-cover relative'>


            <img src={proj9} loading="lazy" alt="WorkoutX" />
